    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-[#000066]/80 to-[#000033]/90 flex justify-center py-16">
      <div className="max-w-7xl w-full px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="relative group">
              ...
              <div className="relative bg-[#000066]/95 backdrop-blur-md text-white p-8 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.2)] h-full transform hover:scale-[1.02] transition-all duration-500 hover:shadow-[0_12px_40px_rgba(0,0,0,0.3)] border border-blue-400/30 animate-slide-in-left delay-200">
                <div className="absolute inset-0 bg-[url('/grid-pattern.png')] opacity-10 rounded-2xl"></div>
                <div className="absolute top-0 right-0 w-24 h-24 bg-blue-500/10 rounded-full blur-2xl"></div>
                <h2 className="text-3xl font-semibold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200 animate-fade-in relative z-10">Quem Somos</h2>
                <p className="text-lg leading-relaxed animate-slide-in-left delay-300 relative z-10">
          ...
          <div className="lg:col-span-4">
            <div className="relative group">
              ...
              <div className="relative bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.15)] h-full transform hover:scale-[1.02] transition-all duration-500 hover:shadow-[0_12px_40px_rgba(0,0,0,0.25)] border border-blue-200 animate-slide-in-right delay-300">
                ...
                <h2 className="text-3xl font-semibold text-gray-900 mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#000066] to-[#0000cc] animate-fade-in relative z-10">O que buscamos</h2>
                <p className="text-lg text-gray-800 leading-relaxed animate-slide-in-right delay-400 relative z-10">
          ...
          <div className="lg:col-span-4">
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-white/95 to-blue-50/90 backdrop-blur-sm p-8 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.15)] h-full transform hover:scale-[1.02] transition-all duration-500 hover:shadow-[0_12px_40px_rgba(0,0,0,0.25)] border border-blue-200 animate-scale-in delay-400">
                ...
                <h2 className="text-3xl font-semibold text-gray-900 mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#000066] to-[#0000cc] animate-fade-in relative z-10">Nossos valores</h2>
                <ul className="text-lg text-gray-800 space-y-4 animate-scale-in delay-500 relative z-10">
                  <li className="flex items-center gap-3 group hover:translate-x-2 transition-transform duration-300">
                    <span className="text-blue-600 group-hover:scale-110 transition-transform duration-300">✓</span>
        ...
        <div className="mt-8">
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-blue-300 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
            <div className="relative bg-[#000066]/95 backdrop-blur-md text-white p-12 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.2)] w-full text-center transform hover:scale-[1.02] transition-all duration-500 hover:shadow-[0_12px_40px_rgba(0,0,0,0.3)] border border-blue-400/30 animate-slide-in-left delay-500">
              <div className="absolute inset-0 bg-[url('/grid-pattern.png')] opacity-10 rounded-2xl"></div>
              <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 rounded-full blur-2xl"></div>
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-blue-400/10 rounded-full blur-2xl"></div>
              <h2 className="text-4xl font-semibold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200 animate-fade-in relative z-10">Nossa missão</h2>
              <p className="text-lg leading-relaxed max-w-3xl mx-auto animate-slide-in-left delay-600 relative z-10">
