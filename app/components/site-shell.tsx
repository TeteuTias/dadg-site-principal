...
export default function SiteShell({ children }: SiteShellProps) {
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip">
      ...
      <div
        className={cn(
          "fixed inset-0 z-[60] bg-slate-950/28 backdrop-blur-sm transition-opacity lg:hidden",
      ...
      <aside
        className={cn(
          "fixed right-0 top-0 z-[70] flex h-screen w-full max-w-sm flex-col bg-[linear-gradient(180deg,#073059_0%,#041a31_100%)] p-6 text-white shadow-[0_30px_80px_rgba(4,26,49,0.35)] transition-transform duration-300 lg:hidden",
